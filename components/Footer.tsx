    ...
    <div className="grid md:grid-cols-4 gap-8 md:gap-12 lg:gap-16">
      ...
      <div className="flex flex-col">
        <div className="flex items-center gap-2 mb-6">
          ...
          <span className="text-white text-xl font-bold">Include</span>
        </div>
        <p className="text-gray-400 text-sm leading-relaxed">
          Bringing people together through innovative solutions and comprehensive services.
        </p>
        <div className="flex gap-4 mt-6">
          ...
          <a href="#" className="w-6 h-6 text-gray-400 hover:text-blue-400 transition-colors duration-300">
            <svg fill="currentColor" viewBox="0 0 24 24"><path d="M23.953 4.57a10 10 0 002.856-3.915 10 10 0 01-2.856.973 5 5 0 00-8.66 4.57c-4.255-.25-8.027-2.16-10.514-5.14a5 5 0 001.55 6.573 5 5 0 01-2.26-.616v.06a5 5 0 004.006 4.9 5 5 0 01-2.251.086 5 5 0 004.697 3.468 10.01 10.01 0 01-6.177 2.132c-.4 0-.79-.023-1.175-.067a14.001 14.001 0 007.557 2.209c9.053 0 13.998-7.496 13.998-13.985 0-.21 0-.42-.015-.63A9.935 9.935 0 0024 4.59z"/></svg>
          </a>
          <a href="#" className="w-6 h-6 text-gray-400 hover:text-blue-400 transition-colors duration-300">
      ...
      <div className="flex flex-col">
        ...
        <ul className="space-y-2">
          ...
          <li><a href="#services" className="text-gray-400 hover:text-white transition-colors duration-300 text-sm">Strategy</a></li>
          <li><a href="#services" className="text-gray-400 hover:text-white transition-colors duration-300 text-sm">Implementation</a></li>
          <li><a href="#services" className="text-gray-400 hover:text-white transition-colors duration-300 text-sm">Support</a></li>
          <li><a href="#services" className="text-gray-400 hover:text-white transition-colors duration-300 text-sm">Training</a></li>
        </ul>
      </div>
      ...
      <div className="flex flex-col">
        ...
        <div className="space-y-4">
          <div>
            ...
            <a href="mailto:hello@include.com" className="text-gray-300 hover:text-white transition-colors duration-300 text-sm">hello@include.com</a>
          </div>
          <div>
          ...
          <div>
            ...
            <p className="text-gray-300 text-sm">123 Business Ave, Suite 100<br/>New York, NY 10001</p>
          </div>
        </div>
      </div>
    </div>
